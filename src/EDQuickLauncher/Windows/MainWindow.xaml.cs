...
namespace EDQuickLauncher.Windows {
  ...
  public partial class MainWindow : Window {
    ...
    private void ExpansionSwitcher_Initialized(object sender, EventArgs e) {
      if (EnvironmentSettings.NoDirectLaunch) {
        ExpansionSwitcher.Items.Add(new ComboBoxItem().SetBinding(ContentProperty, new Binding("EliteDangerousLauncherLoc")));
      } else {
        ExpansionSwitcher.Items.Add(new ComboBoxItem().SetBinding(ContentProperty, new Binding("EliteDangerousLoc")));
        if (Util.HasExpansion) {
          ExpansionSwitcher.Items.Add(new ComboBoxItem { Content = new Binding("EliteDangerousExpansionLoc") });
        }
      }
    }
