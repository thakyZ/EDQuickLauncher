...
namespace EDQuickLauncher.Windows {
  ...
  public partial class SettingsControl {
    ...
    public void ReloadSettings() {
      ...
      LauncherLanguageComboBox.ItemsSource = SettingsControlViewModel.LauncherLanguageItems;
    ...
    private void GitHubButton_OnClick(object sender, RoutedEventArgs e) => Util.OpenBrowser("https://github.com/thakyZ/EDQuickLauncher");
    ...
    private void OpenI18nLabel_OnClick(object sender, MouseButtonEventArgs e) => Util.OpenBrowser("https://crowdin.com/project/edquicklauncher");
    ...
    private void LicenseText_OnMouseUp(object sender, MouseButtonEventArgs e) => Util.OpenBrowser(Path.Combine(Paths.ResourcesPath, "LICENSE.txt"));
