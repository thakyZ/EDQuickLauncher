  ...
  public partial class CustomMessageBox : Window {
    ...
    public static void Show(string text, string caption, MessageBoxButton buttons = MessageBoxButton.OK, MessageBoxImage image = MessageBoxImage.Asterisk, bool showHelpLinks = true, bool showReportLinks = false) {
      ...
      InvokableApp.Dispatcher.Invoke(() => {
        ...
        box.IntegrityReportButton.Visibility = !showReportLinks ? Visibility.Collapsed : Visibility.Visible;
    ...
    private void IntegrityReportButton_OnClick(object sender, RoutedEventArgs e) => Process.Start(Path.Combine(Paths.RoamingPath, "integrityreport.txt"));
  }
}