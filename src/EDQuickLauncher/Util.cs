...
namespace EDQuickLauncher {
  ...
  public static class Util {
    ...
    public static void OpenDiscord(object sender, RoutedEventArgs e) => OpenBrowser("https://discord.me/nekogaming");

    public static void OpenFaq(object sender, RoutedEventArgs e) => OpenBrowser("https://thakyz.github.io/edquicklauncher-faq/");
